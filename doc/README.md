...
The documentation for `@seneca/salesforce-provider` follows the
...
definition held in the [SDK project](https://github.com/voxgig-sdk/salesforce-sdk). An edit made here
