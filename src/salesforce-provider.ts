...
type SalesforceProviderOptions = {
  // Options passed straight to the SalesforceSDK constructor,
  ...
  // Test feature options, e.g. {entity: {account: {...}}} to
  // seed the mock with data. Only used when `test` is true.
  testopts?: Record<string, any>
}


function SalesforceProvider(this: any, options: SalesforceProviderOptions) {
  ...
  entity.account.cmd.list.action =
    async function list_account(this: any, entize: any, msg: any) {
  ...
  entity.account.cmd.load.action =
    async function load_account(this: any, entize: any, msg: any) {
      const q = cleanq(msg.q)
  ...
  entity.account.cmd.save.action =
    async function save_account(this: any, entize: any, msg: any) {
  ...
  entity.account.cmd.remove.action =
    async function remove_account(this: any, _entize: any, msg: any) {
      const q = cleanq(msg.q)
...
// Default options.
const defaults: SalesforceProviderOptions = {
  sdk: {},
  test: false,
  testopts: {},
}
